...
theme.Product = (function() {
    ...
    Product.prototype = $.extend({}, Product.prototype, {
        ...
        initVariants: function() {
            ...
            this.$container.on('variantChange' + this.namespace, this.updateProductSKU.bind(this));
         ...
         * @param event
         */
        updateProductSKU: function (event) {
            var variant = event.variant;

            if (variant){
                $(selectors.productSku, this.$container)
                    .html(variant.sku);
            }
        },
        /**
...
$(window).load(function() {
    setTimeout(function () {
        if($('.limespot-wrapper .limespot-container').length){
            $('.limespot-wrapper').hide();
        }
    }, 5000)
});
  ...
  if(mode == 'production') { 
    ...
    window.__gfAnimate.registerScroll(jQuery("#e-1570092099356"), '{"animation":{"screens":{"lg":true,"md":true,"sm":true,"xs":true},"name":"slide_in-down","delay":100,"duration":350},"interaction":{"key":"scroll-into-view","type":"level2"}}');

...
(function( jQuery ){
  try {
    var $module = jQuery('#m-1675289516101').children('.module');
    var single = $module.attr('data-single');
    var openDefault = $module.attr('data-openDefault');
    var openTab = $module.attr('data-openTab');
    var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
...
(function( jQuery ){
  try {
    var $module = jQuery('#m-1660701479875').children('.module');
    var single = $module.attr('data-single');
    var openDefault = $module.attr('data-openDefault');
    var openTab = $module.attr('data-openTab');
    var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1660700855526').children('.module');
  $(document).ready(function() {
    ...
    if($('.gempage-editing').length < 1){
      ...
      $(row).find(('.gf_column:nth-child(2) > [data-label="Row"]')).show();
    }

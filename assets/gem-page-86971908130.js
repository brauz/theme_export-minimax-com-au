...
(function( jQuery ){
  try {
    var $module = jQuery('#m-1659075121996').children('.module');
    ...
    (function( jQuery ){
  try {
    var $module = jQuery('#m-1658991813693').children('.module');
    var single = $module.attr('data-single');
    var openDefault = $module.attr('data-openDefault');
    var openTab = $module.attr('data-openTab');
    var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
    ...
    (function( jQuery ){
  try {
    var $module = jQuery('#m-1658991813671').children('.module');
    var single = $module.attr('data-single');
    var openDefault = $module.attr('data-openDefault');
    var openTab = $module.attr('data-openTab');
    var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
    ...
    (function( jQuery ){
  try {
    var $module = jQuery('#m-1658991813623').children('.module');
    var single = $module.attr('data-single');
    var openDefault = $module.attr('data-openDefault');
    var openTab = $module.attr('data-openTab');
    var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1658991813621').children('.module');
  ...
  var $module = jQuery('#m-1658990380436').children('.module');
  $module.gfV2HeroBanner({});
